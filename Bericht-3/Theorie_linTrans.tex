...
\end{align*}
\begin{remark}
	zu $ (\star) $: Integration über inneren Kanten $ F $ fällt weg. Denn über jede innere Kante genau zwei mal integriert wird, einmal pro anliegender Zelle und da die äußeren Normale jeweils entgegengesetzt sind, fällt die Integration weg. Genauer:
...
%	\end{itemize}
	...
	Diese Erhaltungsgrößen konnten jedoch nicht durch die Aufgaben bestätigt werden. 
\end{remark}
