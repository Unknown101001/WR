...
\end{figure}
Uns war es leider nicht möglich nachzuvollziehen, warum wir hierbei Masse verlieren und ein Fehler entsteht. In der Theorie sollte das verwendete Verfahren mit \enquote{upwind flux} und/oder \enquote{central flux} masseerhaltend sein. Leider lässt sich dieser Masseverlust auch nicht mit dem In- und Outflow erklären.
\begin{figure}[H]
	\centering
	\captionabove{Masse, Outflow und Inflow über die Zeit geplottet bei rkorder = -2, deg = 0, lvl = 6}
	\includegraphics[width=0.8\textwidth]{../Aufgabe21/Masseerhaltung/plot.png}
\end{figure}
Wir erhalten als Werte:
\begin{itemize}
	\item Masse bei $ t = 0 $: 20.3125
	\item Masse bei $ t = 7 $: 14.4885
	\item Outflow (aufsummiert) : 13.6301
	\item Inflow (aufsummiert): -0.0989
\end{itemize}


Das gleiche Phänomen ist auch bei Problem B mit deg = 0 (Finite Volumen Ansatz) aufgetreten


\begin{figure}[H]
	\centering
	\captionabove{Problem B}
	\subfigure[deg = 0]{\includegraphics[width=0.49\textwidth]{../Aufgabe21/Masseerhaltung_b_deg_0/plot.png}}
	\subfigure[deg = 2]{\includegraphics[width=0.49\textwidth]{../Aufgabe21/Masseerhaltung_b_deg_2/plot.png}}
\end{figure}
