...
In Aufgabe 7 betrachteten wir die beiden heterogenen Problem 'Divergent' und 'Kellog' unter ähnlichen Gesichtspunkten wie zuvor bereits 'Simple' und 'Discontinuous'.
\begin{figure}[H]
	\centering
	\captionabove{Probleme Divergent}
...
\end{figure}
Beim Problem 'Divergent' erhielten wir für die Größen 'Flux Loss' und 'Flux Error' stark schwankende Ergebnisse. Es war hier insbesondere nicht wirklich möglich eine
\begin{figure}[H]
	\centering
