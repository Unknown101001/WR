...
\begin{align*}
\int_{\Omega}{q \nabla \Phi dx} = \int_{\partial \Omega}{\Phi q \cdot \nu da}
\end{align*}
\item[b)] Sei $\int_{\Omega}{q \nabla \Phi dx} = \int_{\partial \Omega}{g \Phi da}$. Dann gilt für alle Testfunktionen $\Phi : \Omega \rightarrow \R$ 
\begin{align*}
...
\begin{align*}
\int_{\Omega}{q \nabla \Phi dx} = \int_{\partial \Omega}{g \Phi da} = 0 \text{ } \forall \Phi : \Omega \rightarrow \R \text{ mit } \Phi = 0 \text{ auf }\partial\Omega  
\end{align*}
dann gilt: 
\begin{align*}
...
Grundsätzlich sieht man, dass es  sich lohnt für ein symmetrisches Problem wie Simple2D das CG-Verfahren zu benutzen.
