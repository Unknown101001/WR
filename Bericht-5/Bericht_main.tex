...
\DeclareMathOperator{\FIn}{\mathcal{F}_h^{\text{in}}}
\DeclareMathOperator{\FD}{\mathcal{F}_h^{\text{D}}}
\DeclareMathOperator{\FN}{\mathcal{F}_h^{\text{N}}}
\DeclareMathOperator{\F}{\mathcal{F}_h}
\DeclareMathOperator{\asip}{a_h^{\text{SIP}}}
\DeclareMathOperator{\bsip}{b_h^{\text{SIP}}}

\numberwithin{equation}{section} 


% Praktikumsbericht nummer setzen
\newcommand{\BerichtNR}{5}
...
\section{Zusammenfassung: Discontinuous-Galerkin-Verfahren~(dG) }
\input{Theorie}
\newpage
\section{Ergebnisse der Aufgaben}
\input{Aufgaben_Ergebnisse}
\section{Aufgabe 38}
\input{Aufgabe38}
