...
\begin{figure}[H]
	...
	\subfigure[auf Level = 0]{\includegraphics[width=0.85\textwidth]{../Aufgabe31/Maxdiff/Heatmapblub.png}}
\end{figure}
...
\begin{figure}[H]
	...
	\subfigure[auf Level = 0]{\includegraphics[width=0.85\textwidth]{../Aufgabe31/Maxdiff/Heatmapblub1.png}}
\end{figure}
